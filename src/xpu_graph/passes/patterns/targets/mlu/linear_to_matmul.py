...
@register_this_as_plugin_pattern((torch.empty(10, 10), torch.empty(10, 10)), linear_replace, Target.mlu, ignore_literal=True)
...
@register_this_as_plugin_pattern((torch.empty(10, 10), torch.empty(10, 10), torch.empty(10,)), linear_bias_replace, Target.mlu, ignore_literal=True)
